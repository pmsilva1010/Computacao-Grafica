...
GLfloat  obsidianAmb []={ 0.05375 ,0.05 ,0.06625 };	//2 FIXE PARA O BOW
...
GLfloat  rubyAmb []={ 0.1745 ,0.01175 ,0.01175 };		//talvez parede
GLfloat  rubyDif []={   0.61424 ,0.04136 ,0.04136 };
GLfloat  rubySpec []={ 0.727811 ,0.626959 ,0.626959 };
GLint  rubyCoef = 0.6 *128;

GLfloat  turquoiseAmb []={ 0.1 ,0.18725 ,0.1745 };			//talvez vidro
...
GLfloat blackPlasticAmb []={ 0.0 ,0.0 ,0.0 };		//12 talvez Pernas do alvo
...
GLfloat  redPlasticAmb []={ 0.0 ,0.0 ,0.0 };	//talvez paredes
...
GLfloat blueAmb []={ 0 ,0 ,0.0 };
GLfloat blueDif []={   0 ,0 ,1 };
GLfloat blueSpec []={ 0.0225 , 0.0225 , 0.0225 };
GLint blueCoef = 13;

GLfloat whiteAmb []={ 0 ,0 ,0.0 };
GLfloat whiteDif []={ 0.992157 ,0.992157 ,0.992157 };
GLfloat whiteSpec []={ 0.0225 , 0.0225 , 0.0225 };
GLint whiteCoef = 13;

GLfloat yellowAmb []={ 0 ,0 ,0.0 };
GLfloat yellowDif []={ 1 ,0.964706 ,0 };
GLfloat yellowSpec []={ 0.0225 , 0.0225 , 0.0225 };
GLint yellowCoef = 13;

GLfloat redAmb []={ 0 ,0 ,0.0 };
GLfloat redDif []={ 1 , 0 ,0 };
GLfloat redSpec []={ 0.0225 , 0.0225 , 0.0225 };
GLint redCoef = 13;

GLfloat blackAmb []={ 0 ,0 ,0.0 };
GLfloat blackDif []={ 0 , 0 ,0 };
GLfloat blackSpec []={ 0.0225 , 0.0225 , 0.0225 };
GLint blackCoef = 13;

GLfloat greenAmb []={ 0 ,0 ,0.0 };
GLfloat greenDif []={ 0 , 1 ,0 };
GLfloat greenSpec []={ 0.0225 , 0.0225 , 0.0225 };
GLint greenCoef = 13;
